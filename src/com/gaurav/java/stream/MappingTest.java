...
public static void main(String[] args) {
		...
		List<String> studentNameList = studentList.stream().collect(Collectors.mapping(Student::getStudentName, Collectors.toList()));
		System.out.println(studentNameList);
		
		List< String> strings = studentList.stream().filter((s)->s.getGrade().equals("5")).collect(Collectors.mapping(Student::getStudentName, Collectors.toList()));
